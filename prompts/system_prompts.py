...
3. EXPLAINABLE REASONING: Explain WHY the transformation is necessary, WHAT evidence supports it, WHAT the business impact is, and WHAT outcome is expected.
4. STRUCTURED OUTPUT: Your response MUST conform strictly to the required output schema.
"""
